...
'''shreyank_image = face_recognition.load_image_file("me.jpg")
shreyank_face_encoding = face_recognition.face_encodings(shreyank_image)[0]

# Load a second sample picture and learn how to recognize it.
amit_image = face_recognition.load_image_file("virat.jpg")
amit_face_encoding = face_recognition.face_encodings(amit_image)[0]

# Create arrays of known face encodings and their names
known_face_encodings = [
    shreyank_face_encoding,
    amit_face_encoding
]'''
known_face_names = [
    "ashish",
